(function () {
	//window.UEDITOR_HOME_URL = "/platform/platform-resource/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        // ,savePath: [ 'upload1', 'upload2', 'upload3' ] //图片保存在服务器端的目录， 默认为空，
		// 此时在上传图片时会向服务器请求保存图片的目录列表，
        // 如果用户不希望发送请求，
		// 则可以在这里设置与服务器端能够对应上的目录名称列表
        // 比如： savePath: [
		// 'upload1',
		// 'upload2' ]
        // 涂鸦图片配置区
        ...
        , toolbars : [ [ 'fullscreen', 'source', '|', 'undo', 'redo', '|',
        				...
        				'imageright', 'imagecenter', '|', 'emotion',
        				...
        				'charts', '|', 'print', 'preview', 'searchreplace',
        				'drafts' ]]
